...
describe 'dirname' do
  ...
  it { is_expected.to run.with_params(:undef).and_raise_error(Puppet::ParseError, %r{Requires string as argument}) }
  it { is_expected.to run.with_params(nil).and_raise_error(Puppet::ParseError, %r{Requires string as argument}) }
