Puppet::Functions.create_function(:validate_slength) do
  ...
  def deprecation_gen(scope, *args)
    call_function('deprecation', 'validate_slength', _("This method is deprecated, please use the stdlib validate_legacy function, with String[]. There is further documentation for validate_legacy function in the README."))
