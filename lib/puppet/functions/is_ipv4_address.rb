Puppet::Functions.create_function(:is_ipv4_address) do
  ...
  def deprecation_gen(scope, *args)
    call_function('deprecation', 'is_ipv4_address', _("This method is deprecated, please use match expressions with Stdlib::Compat::Ipv4 instead. They are described at https://docs.puppet.com/puppet/latest/reference/lang_data_type.html#match-expressions."))
