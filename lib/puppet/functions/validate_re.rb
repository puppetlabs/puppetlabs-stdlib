Puppet::Functions.create_function(:validate_re) do
  ...
  def deprecation_gen(scope, *args)
    call_function('deprecation', 'validate_re', _("This method is deprecated, please use the stdlib validate_legacy function, with Pattern[]. There is further documentation for validate_legacy function in the README."))
