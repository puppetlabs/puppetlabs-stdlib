Puppet::Functions.create_function(:is_array) do
  ...
  def deprecation_gen(scope, *args)
    call_function('deprecation', 'is_array', _("This method is deprecated, please use match expressions with Stdlib::Compat::Array instead. They are described at https://docs.puppet.com/puppet/latest/reference/lang_data_type.html#match-expressions."))
