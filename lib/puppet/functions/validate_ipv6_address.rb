Puppet::Functions.create_function(:validate_ipv6_address) do
  ...
  def deprecation_gen(scope, *args)
    call_function('deprecation', 'validate_ipv6_address', _("This method is deprecated, please use the stdlib validate_legacy function, with Stdlib::Compat::Ipv6_address. There is further documentation for validate_legacy function in the README."))
