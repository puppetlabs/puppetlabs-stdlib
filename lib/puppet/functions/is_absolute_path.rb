Puppet::Functions.create_function(:is_absolute_path) do
  ...
  def deprecation_gen(scope, *args)
    call_function('deprecation', 'is_absolute_path', _("This method is deprecated, please use match expressions with Stdlib::Compat::Absolute_Path instead. They are described at https://docs.puppet.com/puppet/latest/reference/lang_data_type.html#match-expressions."))
