Puppet::Functions.create_function(:is_float) do
  ...
  def deprecation_gen(scope, *args)
    call_function('deprecation', 'is_float', _("This method is deprecated, please use match expressions with Stdlib::Compat::Float instead. They are described at https://docs.puppet.com/puppet/latest/reference/lang_data_type.html#match-expressions."))
