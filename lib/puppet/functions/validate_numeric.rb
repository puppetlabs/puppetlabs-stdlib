Puppet::Functions.create_function(:validate_numeric) do
  ...
  def deprecation_gen(scope, *args)
    call_function('deprecation', 'validate_numeric', _("This method is deprecated, please use the stdlib validate_legacy function, with Stdlib::Compat::Numeric. There is further documentation for validate_legacy function in the README."))
