module Puppet::Parser::Functions
  ...
  newfunction(:validate_slength, :doc => _(<<-'ENDHEREDOC')) do |args|
    ...
    raise Puppet::ParseError, _("validate_slength(): Expected second argument to be equal to or larger than third argument") unless max_length >= min_length
