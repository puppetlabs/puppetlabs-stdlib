...
module Puppet::Parser::Functions
  newfunction(:parseyaml, :type => :rvalue, :doc => _(<<-EOS)
...
be returned if the parsing of YAML string have failed.
  EOS
    ...
    raise ArgumentError, _('Wrong number of arguments. 1 or 2 arguments should be provided.') unless arguments.length >= 1
    require 'yaml'
