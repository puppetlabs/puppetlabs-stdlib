...
module Puppet::Parser::Functions
  newfunction(:has_interface_with, :type => :rvalue, :doc => _(<<-EOS)
...
has_interface_with("lo")                        => true
    ...
    raise(Puppet::ParseError, _("has_interface_with(): Wrong number of arguments given (%{num_args} for 1 or 2)") % { num_args: args.size }) if args.size < 1 or args.size > 2
