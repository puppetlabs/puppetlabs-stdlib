...
EOS
  ...
  raise(ArgumentError, _("seeded_rand(): first argument must be a positive integer")) unless function_is_integer([args[0]]) and args[0].to_i > 0
  raise(ArgumentError, _("seeded_rand(): second argument must be a string")) unless args[1].is_a? String
